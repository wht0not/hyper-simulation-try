...
DEFAULT_OUTPUT_PATH = "musique_time.json"
...
def run_musique_multihop_evaluation(
	...
	for instance_dir in tqdm(instance_dirs, desc="MuSiQue multi-hop QA", unit="inst"):
		...
		mapping, q_map, d_map = compute_hyper_simulation(query_hg, merged_hg, sigma_threshold=sigma, b_threshold=b, delta_threshold=delta)
		end_time = time.time()
